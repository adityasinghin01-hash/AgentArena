...
const SECURITY_HEADERS = {
  ...
  'Cross-Origin-Embedder-Policy': 'unsafe-none',        // was require-corp — blocks frontend fetch
  'Cross-Origin-Opener-Policy': 'same-origin',
  'Cross-Origin-Resource-Policy': 'cross-origin',        // was same-origin — blocks cross-port API calls
};
